...
fn resolve_root() -> ExternResult<ResolvedBootstrapRoot> {
    ...
    let contributions = vec![
        contribution(
            ...
            constitution_digest_to_core(constitution_after.currentness_evidence_digest),
