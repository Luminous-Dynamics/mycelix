...
class Tests(unittest.TestCase):
    ...
    def test_toolchain_accepts_196(self):
        rustc = {"argv": ["rustc", "-Vv"], "returncode": 0, "stdout": "rustc 1.96.0 (x)\nrelease: 1.96.0\n", "stderr": ""}
        cargo = {"argv": ["cargo", "--version"], "returncode": 0, "stdout": "cargo 1.96.0 (x)\n", "stderr": ""}
        self.assertEqual(q.verify_toolchain_versions(rustc, cargo), {"rustc_release": "1.96.0", "cargo_release": "1.96.0"})

    def test_toolchain_rejects_wrong_rustc(self):
        rustc = {"argv": ["rustc", "-Vv"], "returncode": 0, "stdout": "rustc 1.97.0 (x)\nrelease: 1.97.0\n", "stderr": ""}
        cargo = {"argv": ["cargo", "--version"], "returncode": 0, "stdout": "cargo 1.96.0 (x)\n", "stderr": ""}
        with self.assertRaises(q.QualificationError):
            q.verify_toolchain_versions(rustc, cargo)

    def test_toolchain_rejects_wrong_cargo(self):
        rustc = {"argv": ["rustc", "-Vv"], "returncode": 0, "stdout": "rustc 1.96.0 (x)\nrelease: 1.96.0\n", "stderr": ""}
        cargo = {"argv": ["cargo", "--version"], "returncode": 0, "stdout": "cargo 1.97.0 (x)\n", "stderr": ""}
        with self.assertRaises(q.QualificationError):
            q.verify_toolchain_versions(rustc, cargo)
