...
// Profile-relative scientific lineage / independence policy
pub use lineage::{
    DimensionEvaluation, IndependenceEvaluation, IndependencePolicy, IndependenceProfile,
    IndependenceRequirement, IndependenceState, LineageDimension,
};
