...
topology_id_type!(SubjectBoundaryId, IdentifierKind::SubjectBoundary);
...
mod tests {
    ...
    fn single_runtime_boundary_requires_one_anchored_operational_component() {
        ...
        invalid
            .components
            .push(operational_node(21, operational(1, 4, 5)));
        assert_eq!(
    ...
    fn service_pool_topology_records_operational_multiplicity_only() {
        ...
        let qualified = validate_candidate_subject_boundary(boundary).expect("valid service pool");
