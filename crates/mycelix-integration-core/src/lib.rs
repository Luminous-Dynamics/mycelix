...
mod tests {
    ...
    #[test]
    fn canonical_external_object_v1_matches_fixed_vector() {
        assert_eq!(
            subject().canonical_commitment_v1().digest,
            [
                0xee, 0x92, 0x4d, 0x3a, 0x04, 0x61, 0xdc, 0x89, 0x16, 0x97, 0xe6, 0xd7,
                0x61, 0x20, 0xfb, 0x79, 0xd6, 0x7b, 0x73, 0x7d, 0x63, 0x16, 0xeb, 0x99,
                0x73, 0x4a, 0xc4, 0xd4, 0x0e, 0xc5, 0xd3, 0x24,
            ]
        );
    }

    #[test]
    fn canonical_event_v1_matches_fixed_vector() {
        assert_eq!(
            envelope().canonical_commitment_v1().digest,
            [
                0x35, 0xce, 0x20, 0x92, 0x87, 0x3d, 0x11, 0xc8, 0x6f, 0xbe, 0x0e, 0x6e,
                0xcb, 0x6e, 0x32, 0x68, 0x4f, 0x4d, 0x31, 0x1a, 0x69, 0x6b, 0x1a, 0x89,
                0x10, 0x90, 0xd9, 0x54, 0x73, 0x43, 0x7c, 0x3a,
            ]
        );
    }
