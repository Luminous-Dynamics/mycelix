...
#[allow(deprecated)]
pub type LegacyV1GovernanceRequirement = mycelix_bridge_common::GovernanceRequirement;

/// Eligibility result returned by the existing LegacyV1 gate.
pub type LegacyV1GovernanceEligibility = mycelix_bridge_common::GovernanceEligibility;
