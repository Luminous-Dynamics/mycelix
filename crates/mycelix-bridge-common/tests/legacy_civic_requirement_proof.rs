...
use mycelix_bridge_common::{
    ...
    SovereignDimension, SovereignProfile, sovereign_gate::governance_requirement_from_civic,
};
...
fn try_civic_requirement_from_governance(
    ...
    let min_identity =
        checked_threshold(legacy.min_identity, ConversionError::InvalidIdentityMinimum)?;
