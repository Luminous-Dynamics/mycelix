...
EXPECTED_TOP_LEVEL = {
    ...
    "artifact_kinds", "required_reference_kinds", "required_non_equivalences",
    "forbidden_caller_selected_positive_fields", "verification_scope_rules", "adversarial_case_ids",
    "continuation", "nonclaims",
}
EXPECTED_DEPS = [
...
EXPECTED_ARTIFACTS = ["CompletionClaim", "CompletionEvidenceBundle", "CompletionVerificationEvidence"]
EXPECTED_REFS = [
    "ExternalCommitmentRef", "EvidenceRef", "CollectionSourceRef", "TimeEvidenceRef", "LocationScopeRef",
    "MethodRef", "VerificationPredicateRef", "VerificationMethodRef", "VerifierQualificationRef",
    "VerifierIndependenceProfileRef", "InputEvidenceCutRef", "VerificationResultRef", "OutcomeObservationRef",
    "ExecutionReceiptRef", "AuthorityDecisionRef",
]
EXPECTED_NON_EQUIVALENCES = [
    "Commitment != AuthorityToExecute", "Commitment != CompletionClaim",
    "CompletionClaim != CompletionEvidence", "CompletionEvidence != CompletionVerification",
    "CompletionVerification != OutcomeObservation", "VerifiedCompletion != OutcomeImprovement",
    "OutcomeObservation != CausalEffect", "ExecutionReceipt != CompletionVerification",
    "ProviderAcknowledgement != Completion", "Payment != Completion", "PhotoOrDocument != Completion",
    "DifferentVerifierId != IndependentVerification", "Verification != BeneficiaryAcceptance",
    "Verification != QualityBeyondVerifiedPredicate", "CompletionVerification != PaymentAuthority",
    "VerifiedCompletion != PaymentDue",
]
EXPECTED_FORBIDDEN_FIELDS = ["verified", "official", "paid", "accepted", "successful", "outcome_improved", "independent"]
...
EXPECTED_ATTACKS = [
    "CIV-COMP-T-001_WRONG_COMMITMENT_REVISION", "CIV-COMP-T-002_REUSED_EVIDENCE",
    "CIV-COMP-T-003_OUT_OF_SCOPE_EVIDENCE", "CIV-COMP-T-004_PROVIDER_ACK_WITHOUT_RESULT",
    "CIV-COMP-T-005_PAYMENT_WITHOUT_COMPLETION", "CIV-COMP-T-006_EXECUTION_RECEIPT_PREDICATE_MISMATCH",
    "CIV-COMP-T-007_CLAIMANT_VERIFIER_CONFLICT", "CIV-COMP-T-008_SHARED_VERIFIER_FAULT_DOMAIN",
    "CIV-COMP-T-009_PREDICATE_UI_OVERCLAIM", "CIV-COMP-T-010_LATER_CONTRADICTORY_EVIDENCE",
    "CIV-COMP-T-011_COMPLETED_BUT_OUTCOME_WORSE", "CIV-COMP-T-012_OUTCOME_IMPROVES_WITHOUT_ATTRIBUTION",
...
EXPECTED_NONCLAIMS = [
    "runtime_commitment_registry", "obligation_engine", "execution_authority", "evidence_authenticity",
    "completion_truth", "verifier_independence", "service_quality", "beneficiary_acceptance",
    "payment_authority", "outcome_improvement", "causal_effect", "municipal_legitimacy",
    "johannesburg_deployment", "deployment_readiness",
]
...
def main() -> int:
    ...
    exact("parent subject", data["parent_subject"], "306aee19526c4e88130372152d64365e509f79eb")
