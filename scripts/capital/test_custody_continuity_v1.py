...
class CustodyTests(unittest.TestCase):
    ...
    def test_event_tip_currentness_boundary_explicit(self):
        r=self.q(self.case())
        self.assertFalse(r["event_tip_currentness_established"])
        self.assertFalse(r["uses_local_wall_clock"])
        self.assertIn("custody CURRENT is relative to the supplied event history and does not establish that its tip is the latest designated registry tip", r["nonclaims"])
