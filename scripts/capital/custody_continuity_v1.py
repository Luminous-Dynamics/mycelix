...
"custody CURRENT is relative to the supplied event history and does not establish that its tip is the latest designated registry tip",
)
...
def qualify(p:dict[str,Any],acceptance:dict[str,Any],events:Any)->QualifiedCustody:
    ...
    receipt={
      ...
      "event_tip_currentness_established":False,
