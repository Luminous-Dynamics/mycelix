...
def main():
 ...
 assert p['membership_start']=='before-gate-exec'
 assert p['descendant_scope']=='cgroup-membership-preserving'
 assert p['session_process_group_escape_covered'] is True
 assert p['hostile_code_sandbox'] is False
