...
def main() -> int:
    ...
    attime = int(m["verification_time"]["unix_seconds"])
    if attime != 1790812800:
        raise AssertionError("verification-time drift")
    ...
    with tempfile.TemporaryDirectory(prefix="sup-civ-c2b2b0-") as td:
        ...
        print(f"verification-attime={attime}")
        ...
        print("SUP-CIV-000D1C2B2B0 R2 PASS: exact ML-KEM recipient certificate/RID fixture verified")
    return 0
