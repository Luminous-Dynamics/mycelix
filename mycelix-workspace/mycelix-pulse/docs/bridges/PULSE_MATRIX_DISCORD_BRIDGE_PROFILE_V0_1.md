...
Status: **R2 SOURCE CANDIDATE / NOT QUALIFIED / NOT PASS**
...
- explicit Matrix state and ephemeral treatment without collapsing either into moderation/relation semantics;
...
A future qualification PASS for this exact r2 profile/corpus may establish only that the supplied provider semantics and expected classifications are internally consistent under the frozen v0.1 rules.
