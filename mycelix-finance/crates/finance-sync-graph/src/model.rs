...
#[derive(Deserialize)]
#[serde(deny_unknown_fields)]
struct AssetAmountWireV1 {
    atomic_units: u64,
    asset: mycelix_finance_exact::AssetId,
}

fn deserialize_closed_asset_amount<'de, D>(deserializer: D) -> Result<AssetAmount, D::Error>
where
    D: Deserializer<'de>,
{
    let wire = AssetAmountWireV1::deserialize(deserializer)?;
...
pub struct SettlementLegSpecV1 {
    ...
    #[serde(deserialize_with = "deserialize_closed_asset_amount")]
