...
Authority-significant Serde inputs also fail closed on unknown fields:
...
or opaque provider receipts and having those fields silently discarded while a
graph is constructed from the remaining visible semantics.
