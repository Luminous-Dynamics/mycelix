...
No real provider legal text is reproduced here. Every subject and terms profile in the fixture is synthetic. The corpus tests compatibility logic, obligation preservation, uncertainty, split-role restrictions, multi-source composition, and authority ceilings.
...
The JSON fixture contains exactly 16 preregistered cases covering:
